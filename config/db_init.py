...
dm_cabinet = r'create table dm_cabinet(cid serial PRIMARY KEY,motor char(30) REFERENCES dm_motor (motor),cabinet char(30) NOT NULL,row char(10),col char(10),height char(2),dateline int,date_str char(30),description varchar(255),UNIQUE (motor,cabinet))'
