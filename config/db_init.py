...
dm_motor = r'create table dm_motor(mid serial PRIMARY KEY,motor char(30) NOT NULL UNIQUE,address varchar(100),admin char(15),phone char(20),dateline int,date_str char(30),create_date int,create_date_str char(30),description varchar(255))'
